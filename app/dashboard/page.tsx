...
export default function DashboardPage() {
  ...
  const isFreeUser = planContext?.isFreeUser ?? true; // Default to free, context not ready
  ...
  const filteredBoards = boards.filter((board: Board) => {
    ...
    const matchesDateRange =
      (!filters.dateRange.from || boardDate >= filters.dateRange.from) &&
      (!filters.dateRange.to || boardDate <= filters.dateRange.to);
          ...
          {boards.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
              ...
              <Card className="border-2 border-dashed border-gray-300 hover:border-blue-400 transition-colors cursor-pointer">
                <CardContent
                  className="p-4 sm:p-6 flex flex-col items-center justify-center h-full min-h-[180px]"
            ...
            <div>
              ...
              <Card className="mt-4 border-2 border-dashed border-gray-300 hover:border-blue-400 transition-colors cursor-pointer">
                <CardContent
      ...
      <Dialog open={isFilterOpen} onOpenChange={setIsFilterOpen}>
        <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label className="space-y-2">Task count</Label>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <div>
            ...
            <div className="flex flex-col sm:flex-row justify-between pt-4 space-y-2 sm:space-y-0 sm:space-x-2">
              ...
              <Button onClick={() => setIsFilterOpen(false)} type="submit">
                Apply Filters
              </Button>
            </div>
          </div>
      ...
      <Dialog open={showUpgradeDialog} onOpenChange={setShowUpgradeDialog}>
        <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
          <DialogHeader>
            ...
            <p className="text-sm text-gray-600">
              Free users can only create 1 board. Upgrade to Pro to create
              unlimited boards and access advanced features.
            </p>
          </DialogHeader>
          <div>
            <Button
